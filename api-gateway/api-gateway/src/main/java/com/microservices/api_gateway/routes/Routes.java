...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute(){
        return (RouterFunction<ServerResponse>) route("product_service_swagger")
    ...
    public RouterFunction<ServerResponse> orderServiceSwaggerRoute(){
        return (RouterFunction<ServerResponse>) route("order_service_swagger")
    ...
    //The filter sets the path /api-docs instead of "/aggregate/order-service/v3/api-docs" this
    //Its looks like "http://localhost:8081/aggregate/order-service/v3/api-docs" -->  http://localhost:8081/api-docs


    @Bean
    public RouterFunction<ServerResponse> inventoryServiceSwaggerRoute(){
        return (RouterFunction<ServerResponse>) route("inventory_service_swagger")
    ...
    //The filter sets the path /api-docs instead of "/aggregate/inventory-service/v3/api-docs" this
    //Its looks like "http://localhost:8082/aggregate/inventory-service/v3/api-docs" -->  http://localhost:8082/api-docs
